			...
			if ($().DataTable) {
				...
				var ce = $("#datatableRows").DataTable({
					...
					drawCallback: function () {
						...
						$("#pageCountDatatable span").html("Mostrando " + parseInt(e.page.info().start + 1) + "-" + e.page.info().end + " de " + e.page.info().recordsTotal + " itens")
					}
				});
